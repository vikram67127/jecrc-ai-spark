  ...
  head: () => ({
    meta: [
      ...
      { title: "Vishal Kumar Modi — AI/ML Student & Builder" },
      {
        name: "description",
        content:
          "Portfolio of Vishal Kumar Modi, first-year B.Tech student learning AI/ML, Data Science and building real-world projects.",
      },
      { name: "author", content: "Vishal Kumar Modi" },
